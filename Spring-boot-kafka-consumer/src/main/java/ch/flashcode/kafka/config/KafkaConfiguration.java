package ch.flashcode.kafka.config;
...
public class KafkaConfiguration {
	    ...
	    @Bean
	    public ConsumerFactory<String, List<User>> userConsumerFactory() {
	    ...
	    @Bean
	    public ConcurrentKafkaListenerContainerFactory<String, List<User>> userKafkaListenerFactory() {
